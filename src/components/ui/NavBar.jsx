    ...
    return (
        <NavBarWrap>
            ...
            <NavFooterItem
                ...
                inActiveIcon={
                    process.env.PUBLIC_URL + "/icons/icon-message-circle.png"
                }
            />
            <NavFooterItem
                link="/editpost"
                content="게시글 작성"
                activeIcon={process.env.PUBLIC_URL + "/icons/icon-edit.png"}
                inActiveIcon={process.env.PUBLIC_URL + "/icons/icon-edit.png"}
            />
            <NavFooterItem
                link={"/myprofile"}
                content="프로필"
                ...
                inActiveIcon={process.env.PUBLIC_URL + "/icons/icon-user.png"}
            />
        </NavBarWrap>
    );
}
